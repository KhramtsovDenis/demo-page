...
- `heart_roadmap.html` и `neem_roadmap.html` получили компактный desktop-режим по аналогии с FW roadmap для ноутбуков и невысоких экранов.
...
3. Для FW проверить, что загружены `assets/fw-release-roadmap.css` и `assets/fw-release-roadmap.js`.
